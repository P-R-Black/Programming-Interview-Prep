...
const reactQuestionBank = [
    {
        ...
        answers: [
            ...
            'PureComponents are components that share data between components, which you can\'t easily share with props',
    ...
    },
    {
        ...
        answers: [
            ...
            '"var" and "const" are block scope, and "let" is functional and block scope. Also "var" and "const" variables can be reinitialized, and "let" variables cannot be reinitialized',
    ...
    },
    {
        ...
        answers: [
            ...
            'Higher order components are not a part of the React API, per se, they are a pattern that emerges from React\'s compositional nature.',
            'No, higer order components are not a part of the React API, they are a component that emerges from React\'s functional nature.',
        ],
        correct: 'Higher order components are not a part of the React API, per se, they are a pattern that emerges from React\'s compositional nature.',
        explanation: '',
        questionId: '22023',
    ...
    {
        question: 'Would the block of code below be considered a React hook?',
        image: CustomHookOne,
        answers: [
            'Yes',
            'No',
        ...
        correct: 'Yes',
        explanation: 'This is a hook (it starts with "use"), although it doesn\’t use any React hooks (useState, useEffect, etc.) inside — which is allowed, though not idiomatic. It’s technically still a custom hook by naming.',
        questionId: '22060',
        keyword: ['Custom React hooks', 'naming conventions'],
    },
    {
        question: 'Would this block of code be considered a React hook?',
        image: CustomHookTwo,
        answers: [
            'Yes',
            'No',
        ...
        correct: 'Yes',
        explanation: 'This is a correct and valid custom hook. It uses React hooks (useState, useEffect) and returns useful state and logic. Nothing wrong here.',
        questionId: '22061',
        keyword: ['Custom React hooks', 'naming conventions'],
    },
    {
