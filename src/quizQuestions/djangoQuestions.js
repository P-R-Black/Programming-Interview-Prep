const djangoQuestionBank =[
   ...
   },
   {
        ...
        answers: [
            ...
            'Middleware is a layer in Django\'s Request/Response processing pieline, that is responsible for performing specific functions or providing specific responses on request.', 
            'Middleware is a dictionary in which keys represent variable names and values represent their values.', 
        ],
        correct: 'Middleware is a layer in Django\'s Request/Response processing pieline, that is responsible for performing specific functions or providing specific responses on request.',
   ...
   },
   {
        ...
        answers: [
            ...
            'A QuerySet icontains the two methods assetEquals, assertTrue and is used for testing.', 
            'A QuerySet is any data in Django that is eclosed inside of parenthesis "()"', 
   ...
   },
   {
        ...
        explanation: 'TestCase has two methods, setUp(self) and tearDown(self), and it contains methods like assetEquals, assertTrue, that are needed to perform unit test.',
        questionId: '23064',
